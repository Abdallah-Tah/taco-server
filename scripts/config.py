...
# ── Position sizing ────────────────────────────────────────────────────────────
DEFAULT_RISK_SOL     = _float("DEFAULT_RISK_SOL",        0.05)
...
# Position sizing (USD)
POLY_DEFAULT_SIZE         = _float("POLY_DEFAULT_SIZE",        5.00)
POLY_HIGH_CONVICTION_SIZE = _float("POLY_HIGH_CONVICTION_SIZE",7.50)
POLY_MAX_SIZE             = _float("POLY_MAX_SIZE",           10.00)
